...
export const heroDataZh = [
  ...
  },
  {
    ...
    title: '2025 · 中国 澳门 · 全运会',
    subtitle: '王者归来——成功卫冕全运会男单冠军',
    quote: '"即使没有了世界排名的光环，王者依然是王者。真正的实力，从来不需要数字来证明。"',
    description: '在没有世界排名的日子里，质疑声从未停止。但他选择用最纯粹的赛场表现回应一切。在澳门，面对新一代的冲击，他在绝境中逆转，在压力下绽放。第六枚全运会金牌入账，成为继马龙之后第二位实现全运会男单蝉联的选手。这不是 comeback，因为他从未离开。'
  },
  {
    ...
    description: '从萨尔布吕肯起步，他带着中国乒乓球的精神踏上欧洲赛场。一天四战，全胜而归，当选MVP。这个冠军，不仅属于萨尔布吕肯俱乐部，更属于每一个支持他的球迷。留洋生涯的第一个冠军，是新的开始，也是向世界宣告：无论身在何处，他都是那个为冠军而生的战士。'
  }
]
...
export const heroEventsData: HeroEvent[] = [
  ...
  },
  {
    ...
    description: '在对手林诗栋一度9:4领先的情况下,樊振东连追7分逆转首局。之后状态爆发,连下三城,以11:5、11:3、11:4的比分获得冠军。这是樊振东在全运会男单项目上的第二次夺冠,成功卫冕。',
  ...
  },
  {
    ...
    description: '第十五届全运会乒乓球男团决赛中，樊振东在个人轮次中战胜王楚钦，实现赛事双杀对手，为团队贡献关键得分。',
    eventType: HeroEventType.Tournament,
    location: '中国澳门',
    finalStanding: '亚军',
    score: null,
