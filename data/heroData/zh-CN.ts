...
export const heroEventsData: HeroEvent[] = [
  ...
  },
  {
    ...
    year: '2025',
    title: '德甲第2轮 - 迎来首胜',
    description: '客场挑战对手,樊振东在第二盘3:1战胜对手,第四盘3:1战胜对手,取得个人德甲首胜,帮助球队3:0获胜。',
  ...
  },
  {
    ...
    year: '2025',
    title: '德甲第3轮 - 继续连胜',
    description: '樊振东3:0战胜对手,帮助球队3:0轻取贝格诺伊施塔特队。',
    eventType: HeroEventType.Tournament,
    location: '德国',
    score: '3-0',
    opponent: '贝格诺伊施塔特'
  },
  {
    ...
    year: '2025',
    title: '全运会男单半决赛 - 击败对手',
    description: '在澳门银河综艺馆上演巅峰对话,樊振东以4:2击败当时世界排名第一的对手,率先挺进决赛。这场比赛展现了樊振东即使在无世界排名的情况下,依然是世界顶尖水平。',
    eventType: HeroEventType.Tournament,
    location: '中国澳门'
  },
  {
  ...
  // === 2026年 ===
  {
    ...
    year: '2026',
    title: '德国杯半决赛 - 首秀开门红',
    description: '德国杯新年首秀中,樊振东在第二盘和第四盘连续出场,以3:1战胜葡萄牙17岁小将对手,为球队2:1战平卫冕冠军对手,晋级决赛。',
    eventType: HeroEventType.Tournament,
    location: '德国新乌尔姆',
    score: '3-1',
    opponent: '对手'
  },
  {
    ...
    year: '2026',
    title: '德国杯冠军 - 留洋首冠',
    description: '德国杯决赛4日在德国新乌尔姆市举行。首盘樊振东3:0横扫德国名将对手,为萨尔布吕肯先拔头筹。第四盘樊振东3:0战胜对手,为球队锁定胜局。一天四战全胜,当选MVP。这是樊振东加盟萨尔布吕肯俱乐部以来获得的首个冠军。',
    eventType: HeroEventType.WorldChampionship,
    location: '德国新乌尔姆',
  ...
  },
  {
    ...
    year: '2026',
    title: '德甲第12轮 - 独得2分惜败',
    description: '在德甲第12轮比赛中,萨尔布吕肯主场2:3负于对手。樊振东在第二盘3:0战胜对手,第四盘3:0击败世界冠军对手,独得2分,但队友先后失利,球队最终失利。',
    eventType: HeroEventType.Tournament,
    location: '德国',
    score: '2-3',
    opponent: '对手'
  },
  {
    ...
    description: '在欧冠1/4决赛首回合比赛中,樊振东在第二盘3:2逆转法国名将对手,帮助球队客场3:0战胜对手,在两回合较量中抢占先机。',
    eventType: HeroEventType.Tournament,
    location: '法国',
    score: '3-0',
    opponent: '对手'
